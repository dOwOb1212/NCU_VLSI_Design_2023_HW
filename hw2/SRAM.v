...
//      version:		2007Q4V2
//      comment:		
//      configuration:	 -instname SRAM -words 16384 -bits 8 -frequency 100 -ring_width 2.0 -mux 32 -write_mask off -wp_size 8 -top_layer "met5-9" -power_type rings -horiz met3 -vert met4 -redundancy off -rcols 2 -rrows 2 -bmux off -ser none -ema on -cust_comment "" -bus_notation on -left_bus_delim "[" -right_bus_delim "]" -pwr_gnd_rename "VDD:VDD,VSS:VSS" -prefix "" -pin_space 0.0 -name_case upper -check_instname on -diodes on -inside_ring_type VSS -drive 6 -asvm off -corners ff_1.1_-40.0,ff_1.1_.0,tt_1.0_25.0,ss_0.9_125.0
//
...
//      Test Muxes                  Off
//
//      Creation Date:  2023-03-23 10:41:58Z
//      Version: 	2007Q4V2
//
...
`celldefine
  module SRAM (
   ...
   specify
      ...
      $setuphold(posedge CLK &&& flag, posedge A[13], 1.000, 0.500, NOT_A13);
      $setuphold(posedge CLK &&& flag, negedge A[13], 1.000, 0.500, NOT_A13);
